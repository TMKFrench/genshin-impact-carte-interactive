function onMapClick(e) {
  ...
  if(params['export']) {
    ...
    bossThunderManifestationIcon = 'bossThunderManifestation';
    testIcon = 'test';
    ironIcon = 'iron';
