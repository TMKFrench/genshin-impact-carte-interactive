function onMapClick(e) {
  ...
  if(params['export']) {
    statueIcon = 'statue';
    teleporterIcon = 'teleporter';
    anemoculusIcon = 'anemoculus';
    geoculusIcon = 'geoculus';
    electroculusIcon = 'electroculus';
    panoramaIcon = 'panorama';
    mondstadtshrineIcon = 'mondstadtshrine';
    liyueshrineIcon = 'liyueshrine';
    inazumashrineIcon = 'inazumashrine';
    seelieIcon = 'seelie';
    fireseelieIcon = 'fireseelie';
    debugIcon = 'debug';
    circleIcon = 'circle';
    oneIcon = 'one';
    twoIcon = 'two';
    threeIcon = 'three';
    spiralabyssIcon = 'spiralabyss';
    domainIcon = 'domain';
    trouncedomainIcon = 'trouncedomain';
    blankIcon = 'blank';
    questIcon = 'quest';
    crimsonagateIcon = 'crimsonagate';
    priestIcon = 'priest';
    princessIcon = 'princess';
    scribeIcon = 'scribe';
    doorIcon = 'door';
    challengeIcon = 'challenge';
    unusualhilichurlIcon = 'unusualhilichurl';
    glacialsteelIcon = 'glacialsteel';
    futileendeavorIcon = 'futileendeavor';
    prodigalsonreturnIcon = 'prodigalsonreturn';
    lostinthesnowIcon = 'lostinthesnow';
    treasureguili01Icon = 'treasureguili01';
    treasureguili02Icon = 'treasureguili02';
    treasureguili03Icon = 'treasureguili03';
    treasureguili04Icon = 'treasureguili04';
    bossStormterrorIcon = 'bossStormterror';
    bossAndriusIcon = 'bossAndrius';
    bossHypostasisAnemoIcon = 'bossHypostasisAnemo';
    bossHypostasisElectroIcon = 'bossHypostasisElectro';
    bossHypostasisGeoIcon = 'bossHypostasisGeo';
    bossOceanidIcon = 'bossOceanid';
    bossPrimoGeovishapIcon = 'bossPrimoGeovishap';
    bossRegisvineCryoIcon = 'bossRegisvineCryo';
    bossRegisvinePyroIcon = 'bossRegisvinePyro';
    bossTartagliaIcon = 'bossTartaglia';
    testIcon = 'test';
    ironIcon = 'iron';
    tinplateIcon = 'tinplate';
    electrocristalIcon = 'electrocristal';
    fragrantCedarIcon = 'fragrantCedar';
    waveriderIcon = 'waverider';
    bookIcon = 'book';
  ...
  if(params['export']) {
    ...
    $export.append('## ---------- Groups ---------- ##\n');
    $export.show();

    markers.forEach(function(g) {
      $export.append( 'INSERT INTO genshin_map_group (checkbox, format, uid, title, text, guide, icon) VALUES (\''+((typeof g.checkbox == 'undefined') ? '' : g.checkbox)+'\', \''+g.format+'\', \''+g.id+'\', \''+((typeof g.title == 'undefined') ? '' : htmlEntities(g.title))+'\', \''+((typeof g.text == 'undefined') ? '' : htmlEntities(g.text))+'\', \''+((typeof g.guide == 'undefined') ? '' : 'https://gaming.lebusmagique.fr'+g.guide)+'\', \''+((typeof g.icon == 'undefined') ? '' : g.icon)+'\');\n' );
    });
    ...
    markers.forEach(function(g) {
      ...
      g.markers.forEach(function(m) {
        var shift = 0;
        if(typeof g.region == 'undefined' && typeof m.region == 'undefined') {
            shift = 2560;
        }
        $export.append('INSERT INTO genshin_map_marker (mgroup, uid, format, video, text, guide, title, icon, x, y) VALUES (\''+group+'\', \''+m.id+'\', \''+((typeof m.format == 'undefined') ? '' : m.format)+'\', \''+((typeof m.video == 'undefined') ? '' : m.video)+'\', \''+((typeof m.text == 'undefined') ? '' : htmlEntities(m.text))+'\', \''+((typeof m.guide == 'undefined') ? '' : 'https://gaming.lebusmagique.fr'+m.guide)+'\', \''+((typeof m.title == 'undefined') ? '' : htmlEntities(m.title))+'\', \''+((typeof m.icon == 'undefined') ? '' : m.icon)+'\', \''+(m.coords[0]+shift)+'\', \''+(m.coords[1]+shift)+'\');\n');
      });
    });
  }
