function onMapClick(e) {
  ...
  if(params['export']) {
    ...
    bossAzhdahaIcon = 'bossAzhdaha';
    bossHypostasisCryoIcon = 'bossHypostasisCryo';
    bossHypostasisPyroIcon = 'bossHypostasisPyro';
    bossPmaIcon = 'bossPma';
    bossMaguuKenkiIcon = 'bossMaguuKenki';
    testIcon = 'test';
    ironIcon = 'iron';
