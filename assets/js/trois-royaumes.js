function onMapClick(e) {
  ...
  // Liste des marqueurs
var markers = [{id:'statue',group:statueGroup,format:'image',title:'Statue des Sept',icon:statueIcon,checkbox:true,markers: [],},{id:'teleporter',group:teleporterGroup,format:'image',title:'Téléporteur',icon:teleporterIcon,checkbox:true,markers: [{id:'01',coords:[1186,543],},{id:'02',coords:[2744,978],},{id:'03',coords:[2353,1622],},{id:'04',coords:[2418,1817],},{id:'05',coords:[1415,1423],},{id:'06',coords:[1735,1751],},{id:'07',coords:[1150,1571],},{id:'08',coords:[1853,2237],},{id:'09',coords:[1661,2362],},{id:'10',coords:[2089,2837],},],},{id:'electroculus',group:electroculusGroup,format:'image',title:'Électroculus',icon:electroculusIcon,checkbox:true,markers: [],},{id:'panorama',group:panoramaGroup,format:'image',title:'Panorama',icon:panoramaIcon,checkbox:true,markers: [],},{id:'seelie',group:seelieGroup,format:'video',title:'Fée',icon:seelieIcon,checkbox:true,markers: [{id:'01',coords:[1024,1817],video:'pdNNHrJpz8o',},{id:'02',coords:[1118,1735],video:'4yXX10GECzA',},{id:'03',coords:[1202,1754],video:'EPWs0hhjxf8',},{id:'04',coords:[1125,1691],video:'kZ7hyqiI8JA',},{id:'05',coords:[1264,1474],video:'wbKsts9NQL0',},{id:'06',coords:[1319,1440],video:'LogO2ceiU9g',},{id:'07',coords:[2202,1600],video:'doksQOUSrhw',},{id:'08',coords:[2198,1629],video:'J8EFV8cbC_U',},{id:'09',coords:[2269,1643],video:'Vskjx_hR42I',},{id:'10',coords:[2395,1673],video:'WZ46I03nFlY',},{id:'11',coords:[2385,1836],video:'h6nYFV52tqI',},{id:'12',coords:[2492,1851],video:'94mi9rr49B0',},{id:'13',coords:[1507,2522],video:'-D4oJwKHIag',},{id:'14',coords:[1524,2639],video:'aF0IaZ78VS8',},],},{id:'overlookingview',group:overlookingviewGroup,format:'image',title:'Succès - Splendide vue',guide:'https://gaming.lebusmagique.fr/genshin-impact/guides/splendide-vue/',checkbox:true,markers: [],},{id:'dungeon',group:dungeonGroup,format:'banner',title:'Donjon',guide:'https://gaming.lebusmagique.fr/genshin-impact/fonctionnalites/donjons/',icon:domainIcon,markers: [],},{id:'region',group:regionGroup,format:'region',icon:blankIcon,markers: [],},{id:'quest',group:questGroup,format:'image',title:'Quête',icon:questIcon,checkbox:true,markers: [],},{id:'challenge',group:challengeGroup,format:'video',title:'Défi',icon:challengeIcon,checkbox:true,markers: [{id:'01',coords:[1323,1400],text:'Tuez tous les ennemis en 240 secondes.',video:'M0z6YR_UoJ4',},{id:'02',coords:[1531,1378],text:'Récupérez toutes les particules en 40 secondes',video:'KCPVZITiJTo',},{id:'03',coords:[1462,1435],text:'Tuez tous les ennemis en 150 secondes.',video:'nI8sylnxSgs',},{id:'04',coords:[1418,1448],text:'Tuez tous les ennemis en 180 secondes.',video:'U2Sh_t4gKUw',},{id:'05',coords:[1386,1462],text:'Récupérez toutes les particules en 90 secondes.',video:'P1QlKiFZymw',},{id:'06',coords:[1390,1500],text:'Détruisez tous les barils en 45 secondes.',video:'R9p5grroW3k',},{id:'07',coords:[1113,1597],text:'Récupérez toutes les particules en 180 secondes.',video:'yNKaYhV0dgM',},{id:'08',coords:[1156,1739],text:'Tuez tous les ennemis en 240 secondes.',video:'vrkBeapwwCM',},{id:'09',coords:[2100,1606],text:'Récupérez toutes les particules en 40 secondes.',video:'K_rPZhmh8tU',},{id:'10',coords:[2205,1580],text:'Récupérez toutes les particules en 60 secondes.',video:'30H3loS8vIs',},{id:'11',coords:[2233,1599],text:'Ramenez les 3 fées environnantes pour accéder au défi puis tuez tous les ennemis en 120  secondes.',video:'A4wConEEWmo',},{id:'12',coords:[2447,1466],text:'Récupérez toutes les particules en 60 secondes.',video:'UGk9tVZicdY',},{id:'13',coords:[2257,1695],text:'Tuez tous les ennemis en 60  secondes.',video:'t8G_dfvDteo',},{id:'14',coords:[2335,1684],text:'Détruisez tous les barils en 60 secondes.',video:'0ZJIOKq6_Fw',},{id:'15',coords:[2305,1755],text:'Récupérez toutes les particules en 75 secondes.',video:'C0dLWjgK6QI',},{id:'16',coords:[2462,1825],text:'Tuez tous les ennemis en 120 secondes',video:'BjV1O984WUw',},{id:'17',coords:[1892,2141],text:'Récupérez toutes les particules en 60 secondes.',video:'Qun42HicDFo',},{id:'18',coords:[1701,2188],text:'Tuez tous les ennemis en 120 secondes.',video:'VH6DqvkyICY',},{id:'19',coords:[1533,2192],text:'Récupérez toutes les particules en 240 secondes.',video:'PRXWxsGIb2c',},{id:'20',coords:[1638,2378],text:'Tuez tous les ennemis en 120 secondes.',video:'L6dSYSELECE',},{id:'21',coords:[1675,2389],text:'Récupérez toutes les particules en 80 secondes.',video:'4khAnhLLDRQ',},{id:'22',coords:[1510,2580],text:'Ramenez les 2 fées environnantes pour accéder au défi. Tuez tous les ennemis en 180 secondes.',video:'_Tb74rivDdM',},{id:'23',coords:[1588,2576],text:'Tuez tous les ennemis en 120 secondes.',video:'TxOJIV7YkHI',},{id:'24',coords:[1671,1707],text:'Tuez tous les ennemis en 120 secondes.',video:'bBg5-V5cUtM',},],},{id:'boss',group:bossGroup,format:'image',title:'Boss',markers: [{id:'narukaminomikoto ',coords:[10550,9142],title:'Narukami no Mikoto la destructrice',icon:bossnarukamiIcon,},],},{id:'fishing',group:fishingGroup,format:'popup',title:'Point de pêche',guide:'https://gaming.lebusmagique.fr/genshin-impact/fonctionnalites/la-peche/',icon:fishinghookIcon,markers: [],},{id:'remarkablechest',group:remarkablechestGroup,format:'image',title:'Coffre étrange',icon:inazumachestIcon,checkbox:true,markers: [],},{id:'electroseelie',group:electroseelieGroup,format:'video',title:'Fée électro',icon:electroseelieIcon,checkbox:true,markers: [{id:'01',coords:[1215,694],video:'l6ZGVOZYju8',},{id:'02',coords:[2726,914],video:'ra7H-3ROh3k',},{id:'03',coords:[1096,1734],video:'1JDWp6wHSdE',},{id:'04',coords:[1143,1778],video:'G-lovdtRsSU',},{id:'05',coords:[1188,1670],video:'7LNbjhWu3Z0',},{id:'06',coords:[1765,2019],video:'jn08Kaaes6s',},{id:'07',coords:[2240,1600],video:'GJYvWgCfSIU',},{id:'08',coords:[2282,1647],video:'fuIP7V-oJSg',},{id:'09',coords:[2362,1826],video:'cb6YS73jHFY',},{id:'10',coords:[2473,1924],video:'XQndavL7ru4',},{id:'11',coords:[1689,2277],video:'_cmIpJLFlYo',},{id:'12',coords:[1819,2181],video:'4YCDOBCq-ns',},{id:'13',coords:[1873,2207],video:'ggF-faL99ko',},{id:'14',coords:[1917,2330],video:'Lm-W5PehTTk',},{id:'15',coords:[2130,2855],video:'7ymUEUXmA4U',},],},{id:'sentoutrial',group:sentoutrialGroup,format:'video',title:'Épreuves des mille lumières',text:'Tuez tous les ennemis en 240 secondes.',icon:sentoutrialIcon,checkbox:true,markers: [{id:'01',coords:[1092,1664],video:'ZFNv0_ftlBw',},{id:'02',coords:[1311,1521],video:'8twC_NWho4w',},{id:'03',coords:[2328,1601],video:'QhWONF7CIZk',},{id:'04',coords:[2478,1862],video:'tKt-ImLHiNQ',},{id:'05',coords:[1891,2274],text:'Tuez tous les ennemis en 240 secondes.',video:'9iQaCcML4Jo',},{id:'06',coords:[1697,2351],text:'Tuez tous les ennemis en 240 secondes.',video:'yPwVbcOX7uA',},],},{id:'lightguidingceremony',group:lightguidingceremonyGroup,format:'video',title:'Cérémonies de guidage de la lumière',icon:lightguidingceremonyIcon,checkbox:true,markers: [{id:'01',coords:[1172,1747],video:'cXhaeWKuhSs',},{id:'02',coords:[1186,1488],video:'y0EMl6P_W1s',},{id:'03',coords:[1500,1514],video:'5sW3dEuotOI',},{id:'04',coords:[2518,1461],video:'PFr14nQnwi4',},{id:'05',coords:[2533,1475],video:'3XR6Dd2KnbE',},{id:'06',coords:[2529,1492],video:'yKD56tGnb6A',},{id:'07',coords:[2481,1841],video:'Im1REnw_6bE',},{id:'08',coords:[1895,2137],video:'6PSP_qirA_A',},{id:'09',coords:[1801,2223],video:'rvuul6oEF4k',},{id:'10',coords:[1620,2195],video:'1WVF5i2JNLI',},{id:'11',coords:[1676,2529],video:'IrLLCqbf3zI',},],},{id:'statuevassals',group:statuevassalsGroup,format:'image',title:'Statue de vassal',icon:statuevassalsIcon,checkbox:true,markers: [{id:'01',coords:[1714,1765],},],},];
    ...
    markers.forEach(function(g) {
      ...
      g.markers.forEach(function(m) {
        ...
        if ((typeof m.checkbox !== 'undefined' && m.checkbox) || (typeof g.checkbox !== 'undefined' && g.checkbox))
          checkbox = '<label><input type="checkbox" id="user-marker" data-id="troisroyaumes' + g.id + m.id + '" /><span>Terminé</span></label>';
        ...
        if(format === 'popup')
          ...
          marker.bindPopup(title+'<a href="assets/img/medias/troisroyaumes'+g.id+m.id+'.jpg" class="image" data-lity><img src="thumb/troisroyaumes'+g.id+m.id+'" /></a>'+text+guide+checkbox);
        else if(format === 'banner')
          marker.bindPopup(title+'<img src="assets/img/medias/troisroyaumes'+g.id+m.id+'.jpg" onerror="this.src=\'assets/img/medias/default.jpg\'" />'+text+guide+checkbox);
        else if(format === 'region')
          marker.bindTooltip(m.title, {permanent: true, className: 'region', offset: [0, 13], direction: 'top'}).openTooltip();
        else if(format === 'todo')
          marker.bindPopup('<h4>troisroyaumes' + g.id+m.id  + '</h4>'+'<p><em>Information pour ce marqueur prochainement disponible...</em></p>'+checkbox);
        else if(format === 'gif')
          marker.bindPopup(title+'<a href="assets/img/medias/troisroyaumes'+g.id+m.id+'.gif" class="image" data-lity><img src="assets/img/medias/troisroyaumes'+g.id+m.id+'.gif" /></a>'+text+guide+checkbox);
        ...
        if(userMarkers.indexOf('troisroyaumes'+g.id+m.id) >= 0 && !finished)
          marker.setOpacity(.5);
